...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex bg-[#f3f6fc]">
            {/* ——— Panneau branding (desktop) ——— */}
            <aside className="relative hidden lg:flex lg:w-[46%] flex-col justify-between overflow-hidden bg-gradient-to-br from-[#0a1a3f] via-[#10275c] to-[#1d4ed8] p-12 xl:p-16 text-white">
                {/* Décor */}
            ...
            <main className="relative flex flex-1 items-center justify-center px-6 py-12">
                <div className="w-full max-w-md">
                    ...
                    <div className="anim-in">
                        <div className="mb-8">
                            <h2 className="text-[1.7rem] font-extrabold tracking-tight text-slate-900">
                                {mode === 'login' ? 'Bienvenue 👋' : 'Créez votre compte'}
                            </h2>
                            <p className="mt-1.5 text-sm text-slate-500">
                                {mode === 'login'
                                    ? 'Connectez-vous pour accéder à votre espace partenaire.'
                                    : 'Faites une demande de compte partenaire auprès du cabinet.'}
                            </p>
                        </div>
                        ...
                        {mode === 'login' ? (
                            ...
                            <div className="anim-pop rounded-2xl bg-white p-8 text-center shadow-md ring-1 ring-slate-100">
                            ...
                            <form onSubmit={submitRegister} className="space-y-5">
                                ...
                                <button
                                    type="submit"
                                    disabled={regLoading}
                                    className="w-full rounded-xl bg-emerald-600 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-700 hover:shadow-md disabled:opacity-50"
                                >
